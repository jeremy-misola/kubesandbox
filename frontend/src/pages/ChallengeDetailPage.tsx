...
export function ChallengeDetailPage() {
  ...
  return (
    <div className="max-w-4xl">
      ...
      <div ref={introRef}>
        <p className="eyebrow text-muted-foreground">{data.category}</p>
        <h1 className="mt-3 font-display text-4xl font-normal leading-tight tracking-tight">
          {data.title}
        </h1>

        <div className="eyebrow-xs mt-4 flex flex-wrap items-center gap-x-2 gap-y-1 text-muted-foreground">

  ...
  return (
    <Card className="flex flex-col overflow-hidden p-0">
      ...
      <div className="flex flex-1 flex-col gap-3 p-4">
        ...
        {session.challenge && (
          <span className="eyebrow-xs inline-flex w-fit items-center gap-1.5 border border-accent/30 bg-accent/5 px-2 py-0.5 text-accent">
        ...
        <dl className="grid grid-cols-3 gap-px overflow-hidden rounded-md border border-border/70 bg-border/70 font-mono text-xs">
          {(
            ...
            <div key={k} className="bg-card px-2.5 py-1.5">
              <dt className="eyebrow-xs text-muted-foreground">{k}</dt>

 ...
 *  state, so the layout registers before the environment is ready. */
 ...
 * instructions ~4 cols left, terminal ~8 cols right; stacked on mobile.
 *
...
export function ChallengeWorkspace({ session }: { session: Session }) {
  ...
  return (
    <div className="grid min-h-0 flex-1 grid-cols-1 gap-6 lg:grid-cols-12">
      <aside className="min-h-0 lg:col-span-4 lg:overflow-y-auto">
        {seeded ? (
          <InstructionsPanel
